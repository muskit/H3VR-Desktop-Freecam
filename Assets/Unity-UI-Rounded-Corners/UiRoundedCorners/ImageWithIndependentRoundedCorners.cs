...
namespace Nobi.UiRoundedCorners {
	...
	public class ImageWithIndependentRoundedCorners : MonoBehaviour {
        private static int prop_halfSize;
		private static int prop_radiuses;
		private static int prop_rect2props;
        ...
        private void Awake()
        {
            prop_halfSize = Shader.PropertyToID("_halfSize");
            prop_radiuses = Shader.PropertyToID("_r");
            prop_rect2props = Shader.PropertyToID("_rect2props");
        }
		...
		public void Validate() {
            ...
            if (shader == null)
                shader = MeatKitPlugin.bundle.LoadAsset<Shader>("IndependentRoundedCorners");
